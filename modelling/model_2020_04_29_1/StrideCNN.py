...
class StrideCNN(nn.Module):
    """Tale the best model so far and use stride to lower resolution instead
    of MaxPooling since this is an outdated method."""
    ...
    def __init__(
        ...
        self.conv1 = nn.Conv2d(3, num_1st_filter, 7, stride = 2)
        self.conv2 = nn.Conv2d(num_1st_filter, num_2nd_filter, 3, stride = 2)
        self.conv3 = nn.Conv2d(num_2nd_filter, num_3rd_filter, 3, stride = 2)
        self.conv4 = nn.Conv2d(num_3rd_filter, num_4th_filter, 3, stride = 2)
